...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Ionic Blank\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div class=\"ion-padding\">\n \n      <h1>Hey There, This Is Barcode App.</h1>\n \n    <ion-input type=\"text\"  style=\"background-color: grey; \" [(ngModel)]=\"encodedText\"></ion-input>\n    <ion-button block (click)=\"encode()\">Encode</ion-button>\n    <ion-button block (click)=\"scan()\">Scan</ion-button>\n\n    <div *ngIf=\"scannedData.text\" >\n      <label>Your Barcode is: {{scannedData.text}}</label>\n    </div>\n  </div>\n</ion-content>\n"
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.encode = function () {
        var _this = this;
        this.scanner.encode(this.scanner.Encode.TEXT_TYPE, this.encodedText).then(function (data) {
    ...
    HomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_native_barcode_scanner_ngx__WEBPACK_IMPORTED_MODULE_3__["BarcodeScanner"]])
    ], HomePage);
    return HomePage;
}());
